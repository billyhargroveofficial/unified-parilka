...
TOOL_SCHEMAS: Dict[str, Dict[str, Any]] = {
    ...
    "read_chat_slice": {
        ...
        "description": (
            ...
            "страницей добирается весь запрошенный объём без пропусков и дубликатов. "
            "Используй, когда нужен связный ход переписки, последние сообщения или "
            "весь день, а не отдельные совпадения."
        ),
        "parameters": {
            "type": "object",
            "properties": {
    ...
    "day_digest": {
        ...
        "description": (
            ...
            "указанный период через read_chat_slice; digestState=no_messages значит, "
            "что сообщений за эти дни в кэше нет. Не заменяет внешний поиск."
        ),
        "parameters": {
            "type": "object",
            "properties": {
